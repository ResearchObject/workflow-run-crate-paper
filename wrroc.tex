...
archiving and sharing. However, existing approaches tend to lack interoperable adoption from workflow management systems. In this work we present
...
Different workflow systems have adopted and extended PROV (and its PROV-O representation) to the workflow domain (Pegasus \cite{Deelman 2005}, VisTrails \cite{Scheidegger 2008}), in order to ease the burden of provenance collection from tool developers to workflow management systems (WMSs) \cite{Atkinson 2017}.
...
\begin{itemize}
    ...
    \item Workflow Run RO-Crate Introduction \cite{Leo 2023c} (from Galaxy Smörgåsbord 2023) 
