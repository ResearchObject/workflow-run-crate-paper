...
\begin{table}[!ht]
  ...
  {\bf Example}\\
  \thickhline
  runcrate & Provenance & \url{https://doi.org/10.5281/zenodo.7762627} & \cite{Leo 2023b} \\
  Galaxy & Workflow & \url{https://github.com/galaxyproject/galaxy/releases/tag/v23.0.1} & \cite{De Geest 2023} \\
  COMPSs & Workflow & \url{https://github.com/bsc-wdc/compss/tree/3.2}  & \cite{Poiata 2023} \\
  Streamflow & Provenance & \url{https://github.com/alpha-unito/streamflow/releases/tag/0.2.0.dev10} & \cite{Colonnelli 2023} \\
  WfExS & Workflow & https://github.com/inab/WfExS-backend/releases/tag/0.9.3 & \url{https://github.com/ResearchObject/workflow-run-crate/pull/53} \\
  Sapporo & Workflow & \url{https://github.com/sapporo-wes/sapporo-service/pull/32} & \url{https://github.com/sapporo-wes/sapporo-service/pull/32} \\
  Autosubmit & Workflow & \url{https://earth.bsc.es/gitlab/es/autosubmit/-/merge_requests/317} & \cite{Kinoshita 2023} \\
...
\end{verbatim}
\textbf{Listing 1}: runcrate report command line output. This informal listing of relevant RO-Crate entities describe each step execution. Note that inputs and outputs are of different types (not shown), e.g. \texttt{tissue_low>0.9} is a string parameter, \texttt{6b15de…} is a filename, and \texttt{#af0253…} is a collection.
\end{small}
\end{adjustwidth}
