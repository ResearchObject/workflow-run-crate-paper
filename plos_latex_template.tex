...
To describe the feature values, Sapporo uses the Workflow Run Crate profile extended with additional terms to represent these biological features (\urlhttps://github.com/ResearchObject/ro-terms/tree/master/sapporo}).
...
The Common Provenance Model (CPM)~\cite{Wittner 2022,Wittner 2023b}, an extension of the W3C PROV model~\cite{Moreau 2013}, is a recently developed provenance model that enables the representation of distributed provenance.
